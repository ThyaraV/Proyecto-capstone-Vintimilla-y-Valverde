  ...
  const getActivityLink = (activity) => {
    switch (activity.name) {
      case 'Búsqueda de letra':
        return '/activity/nivel2/1';
      case 'Asociación de fotos':
        return '/activity/nivel2/2';
      case 'Sumas y Restas':
        return '/activity/nivel2/3';
      case 'Encuentra diferencias':
        return '/activity/nivel2/4';
      case 'Forma las frases correctas':
        return '/activity/nivel2/5';
      case 'Clasificación de palabras':
        return '/activity/nivel2/6';
      case 'Memoria a corto plazo':
        return '/activity/nivel2/7';
      case 'Responde preguntas':
        return '/activity/nivel2/8';
      case 'Sigue instrucciones':
        return '/activity/nivel2/9';
      case 'Identificación de objetos y sus usos':
        return '/activity/nivel2/10';
      default:
        return `/activity/nivel2/${activity._id}`;
    }
  };
