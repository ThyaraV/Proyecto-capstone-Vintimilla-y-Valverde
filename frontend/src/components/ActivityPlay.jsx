      ...
      if (activity) {
        ...
        switch (activity.type) {
          case 'busqueda_letras':
            setActivityComponent(<ActivityScreen1 activity={activity} />);
            break;
          case 'asociacion_fotos':
            setActivityComponent(<ActivityScreen2 activity={activity} />);
            break;
          case 'suma_resta':
            setActivityComponent(<ActivityScreen3 activity={activity} />);
            break;
