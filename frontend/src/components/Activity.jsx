// src/components/ActivityLevel1.jsx

import { Card } from 'react-bootstrap';
import backgroundImg from '../images/background1.png'; // Imagen específica para nivel 1

const ActivityLevel1 = ({ activity }) => {
  return (
